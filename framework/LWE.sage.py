...
class LWE(LWE_generic):
    ...
    def __init__(self, n, q, m, D_e, D_s, verbosity=_sage_const_1 , A=None, b=None, s=None, e_vec=None):
        """
        ...
        if A is None:
            A = matrix([[randint(_sage_const_0 , q) for _ in range(n)] for _ in range(m)])
    ...
    def get_dual_basis(self):
        ...
        """
        return build_LWE_lattice(self.A/self.q, _sage_const_1 /self.q).T
