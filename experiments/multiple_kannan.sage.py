...
_sage_const_500 = Integer(500); _sage_const_70 = Integer(70); _sage_const_3301 = Integer(3301); _sage_const_20 = Integer(20); _sage_const_0 = Integer(0); _sage_const_50 = Integer(50); _sage_const_2 = Integer(2)#LWE embedded into EBDD instance  (using Kannan's embedding) (no hints)
import numpy as np
import pandas as pd
import time
...
for x in range(num_experiments):
    ...
    norm = scal(matrix(u) * matrix(u.T))/((n+m)*sigma**_sage_const_2 ) #use built in vector norm
