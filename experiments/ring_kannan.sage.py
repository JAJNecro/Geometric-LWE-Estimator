...
_sage_const_500 = Integer(500); _sage_const_64 = Integer(64); _sage_const_3329 = Integer(3329); _sage_const_20 = Integer(20); _sage_const_0 = Integer(0); _sage_const_50 = Integer(50); _sage_const_2 = Integer(2)#LWE embedded into EBDD instance  (using Kannan's embedding) (no hints)
# using ringlwe
import numpy as np
import pandas as pd
import time
